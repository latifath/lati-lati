<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="{{ couleur_principal() }}">
            ...
            <div class="flex">
              ...
              @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-white">
                    <x-jet-nav-link href="#" :active="request()->routeIs('dashboard')" style="color-white; font-size:14px;">
                        {{ __('Tableau de bord') }}
                    </x-jet-nav-link>
                </div>
            </div>
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('profile.show') }}" style="background-color: #EDF1FF;">
                                {{ __('Profil') }}
                            </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @client
            <x-jet-responsive-nav-link href="{{ route('root_espace_client_index') }}" :active="request()->routeIs('dashboard')">
                {{ __('Tableau de bord') }}
            </x-jet-responsive-nav-link>
            @endclient

            <x-jet-responsive-nav-link href="{{ route('root_espace_admin_index') }}" :active="request()->routeIs('dashboard')">
                {{ __('Tableau de bord') }}
            </x-jet-responsive-nav-link>
        </div>
