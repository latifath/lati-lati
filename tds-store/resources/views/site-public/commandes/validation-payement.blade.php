            ...
            <form action="{{ route('root_site_public_edit_adresse_facturation') }}" id="" method="POST">
                ...
                <div class="modal-body" style="background-color: #f0f0f0;">
                    <div class="">
                        ...
                        <div class="col-md-12 form-group">
                            <label>Rue</label>
                            <input class="form-control {{ $errors->has('rue') ? 'is-invalid' : '' }}" value="{{ adresseclient($commande->adresse_client_id)->rue}}" type="text" placeholder="Numero de la voie et nom de la rue" name="rue">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input class="form-control {{ $errors->has('code_postal') ? 'is-invalid' : '' }}" value="{{ adresseclient($commande->adresse_client_id)->code_postal }}" type="text" placeholder="123" name="code_postal" >
            ...
            <form action="{{ route('root_site_public_edit_adresse_livraison') }}" id="" method="POST">
                <div class="modal-body" style="background-color: #f0f0f0;">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-12 form-group">
                            <label>Rue</label>
                            <input class="form-control {{ $errors->has('rue') ? 'is-invalid' : '' }}" value="{{ adresselivraison($commande->adresse_livraison_id)->rue }}" type="text" placeholder="Numero de la voie et nom de la rue" name="rue">
                            {!! $errors->first('rue', '<p class="text-danger">:message</p>') !!}
                        ...
                        <div class="col-md-12 form-group">
                            <label>Code postal</label>
                            <input class="form-control {{ $errors->has('code_postal') ? 'is-invalid' : '' }}" value="{{ adresselivraison($commande->adresse_livraison_id)->code_postal }}" type="text" placeholder="123" name="code_postal" >
                            {!! $errors->first('code_postal', '<p class="text-danger">:message</p>') !!}
