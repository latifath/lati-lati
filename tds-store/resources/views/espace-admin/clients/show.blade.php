...
<div class="row mt-5">
    <div class="col-md-12 col-sm-12">
        <div class="card m-b-30" >
            <div class="card-body">
                <p class="text-center" style="font-size: 24px;"><strong>Historique de Mr/Mme {{ $client->name }} </strong></p>
...
<div class="modal fade" id="ShowModalCommande" tabindex="-1" aria-labelledby="ShowModalCommandeLabel" aria-hidden="true">
