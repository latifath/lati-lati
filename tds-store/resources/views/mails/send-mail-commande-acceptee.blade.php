...
<div class="card-body">
    ...
    @endif
    <h3>Montant Total TTC: {{ number_format (montant_ttc(montant_apres_reduction_sans_session(total_commande($cmde->id), $cmde->promotion), $cmde->adresse_livraison_id), 0, '.', ' ') }} F CFA</h3>
</div>
